                ...
                <div class="tab-pane fade show active" id="account" role="tabpanel">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h5 class="card-title mb-0">Creat Ticket</h5>
                        </div>
                        <div class="card-body">
						<?php if($f3->exists('SESSION.ticketcreated')){?>
							<p style="background: green; padding: 15px; color: #fff; font-size: 14px;">Your ticket was created sucessfully!</p>
						<?php } ?>
                            <form method="post" action="handler.php">
								...
								<div class="form-row">
									<div class="form-group col-md-6">
										...
										<div class="form-group">
											<select class="form-control" id="impact_level" name="impact_level" required>
												<option value="High">High</option>
												<option value="Medium">Medium</option>
												<option value="Low">Low</option>
											</select>
                                ...
                                <button type="submit" name="createticket" class="btn btn-primary">Save changes</button>
                            </form>
                        </div>
                    </div>
                </div>
