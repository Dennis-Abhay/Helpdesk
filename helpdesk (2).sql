...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2021 at 10:14 PM
...
--
-- Table structure for table `hk_feedbacks`
--

CREATE TABLE `hk_feedbacks` (
  `feedbackid` int(11) NOT NULL,
  `category` varchar(100) NOT NULL,
  `ticketreview` varchar(100) NOT NULL,
  `agentreview` varchar(100) NOT NULL,
...
--
-- Indexes for table `hk_feedbacks`
--
ALTER TABLE `hk_feedbacks`
...
--
-- AUTO_INCREMENT for table `hk_feedbacks`
--
ALTER TABLE `hk_feedbacks`
