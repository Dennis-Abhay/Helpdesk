...
$tickets->load(array('agent=?', $f3->get('SESSION.username')));
            ...
            <nav class="list-group">
				<a class="list-group-item  with-badge" href="dashboard.php"><i class="fa fa-th"></i>Dashbaord<span class="badge badge-primary badge-pill">6</span></a>
                 <?php if($user->hd_staff == 'true'){ ?>
					<a class="list-group-item with-badge active" href="mytickets.php"><i class="fa fa-th"></i>My Tickets<span class="badge badge-primary badge-pill">6</span></a>
				<?php } ?>
			...
			<div class="grid support-content">
				 <div class="grid-body">
					 ...
					 <div class="btn-group">
						...
						<button type="button" class="btn btn-default"><?php $ticketcounter->load(array('status = ? AND agent = ?', "Closed", $f3->get('SESSION.username'))); echo $ticketcounter->loaded(); ?> Closed</button>
					</div>
								...
								<li class="list-group-item clickcontrol" data-id="<?php echo $tickets->ticket_id; ?>">
									<div class="media">
										...
										<div class="media-body">
											<strong><?php echo $tickets->subject; ?></strong> <span class="label label-danger"><?php echo $tickets->impact_level; ?></span><span class="number pull-right"># <?php echo $tickets->ticket_id; ?></span>
