	...
	<body>
		<div class="container bootstrap snippets bootdey">
			<div class="hd-block col-md-4 col-md-offset-4">
				<?php if($f3->exists('SESSION.invalidsignup')){?>
					<p style="background: red; padding: 15px; color: #fff; font-size: 14px;">Username already exists!</p>
				<?php } ?>
		...
		<?php if($f3->exists('SESSION.invalidsignup')){ unset($_SESSION['invalidsignup']); } ?>
	</body>
</html>